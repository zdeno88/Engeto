...
//        System.out.println(room3.getDescription());
        ...
        Reservation res1=new Reservation(adela,null,room1,LocalDate.of(2021,7,19),LocalDate.of(2021,7,26));
        Reservation res2=new Reservation(adela,jan,room3,LocalDate.of(2021,9,1),LocalDate.of(2021,9,14)); 
        list.add(res1);
        list.add(res2);
